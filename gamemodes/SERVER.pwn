...
CreateServerPoint()
{
	...
	//Server Money
	new strings[1024];
	MoneyPickup = CreateDynamicPickup(1239, 23, 997.4766,-1457.2667,13.8060, -1, -1, -1, 50.0);
	format(strings, sizeof(strings), "[Brangkas Money]\n"WHITE_E"Brangkas Bank: "LG_E"%s", FormatMoney(ServerMoney));
	MoneyText = CreateDynamic3DTextLabel(strings, COLOR_LBLUE, 997.4766,-1457.2667,13.8060, 5.0);
	...
	ApotekPickup = CreateDynamicPickup(1241, 23, 1341.716552, 1576.009887, 3010.906250, -1, -1, -1, 50.0);
	format(strings, sizeof(strings), "[Hospital]\n"WHITE_E"Apotek Stock: "LG_E"%d\n"LB_E"/buy", Apotek);
	ApotekText = CreateDynamic3DTextLabel(strings, COLOR_PINK, 1341.716552, 1576.009887, 3010.906250, 5.0); // Apotek hospital
	...
	ObatPickup = CreateDynamicPickup(1241, 23, 1330.2743, 1566.8224, 3010.9063, -1, -1, -1, 50.0);
	...
	ObatText = CreateDynamic3DTextLabel(strings, COLOR_GREY, 1330.2743, 1566.8224, 3010.9063, 5.0); // product
