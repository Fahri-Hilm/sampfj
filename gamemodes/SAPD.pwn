	...
	if(dialogid == DIALOG_SAPD_GARAGE)
	{
		...
		switch(listitem)
		{
			case 0:
			{
				...
				{
					SAPDVeh[playerid] = CreateVehicle(596, 1538.42, -1682.46, 5.59, 92.4917, 0, 1, 120000, 0);
			...
			case 1:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(597, 1538.42, -1682.46, 5.59, 92.4917, 0, 1, 120000, 0);
					AddVehicleComponent(SAPDVeh[playerid], 1098);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 2:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(598, 1538.42, -1682.46, 5.59, 92.4917, 0, 1,120000, 0);
					AddVehicleComponent(SAPDVeh[playerid], 1098);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 3:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(599, 1538.42, -1682.46, 5.59, 92.4917,0,1,120000,0);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 4:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(601, 1538.42, -1682.46, 5.59, 92.4917,0,1,120000,0);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 5:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(427, 1538.42, -1682.46, 5.59, 92.4917,0,1,120000,0);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 6:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(528, 1538.42, -1682.46, 5.59, 92.4917,0,1,120000,0);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 7:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(411, 1538.42, -1682.46, 5.59, 92.4917,0,1,120000,0);
					AddVehicleComponent(SAPDVeh[playerid], 1098);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 8:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(560, 1538.42, -1682.46, 5.59, 92.4917,0,1,120000,0);
			...
			case 9:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(468, 1538.42, -1682.46, 5.59, 92.4917,3,4,120000,0);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 10:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(521, 1538.42, -1682.46, 5.59, 92.4917,3,4,120000,0);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 11:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(523, 1538.42, -1682.46, 5.59, 92.4917,3,4,120000,0);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 12:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(522, 1538.42, -1682.46, 5.59, 92.4917,3,4,120000,0);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 13:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(525, 1538.42, -1682.46, 5.59, 92.4917,3,4,120000,0);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
			case 14:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0, 1568.40, -1695.66, 5.89))
				{
					SAPDVeh[playerid] = CreateVehicle(497, 1569.1587,-1641.0361,28.5788,3,4,120000,0);
				}
				Info(playerid, "You have succefully spawned SAPD Vehicles '"YELLOW_E"/despawnpd"WHITE_E"' to despawn vehicles");
			}
		}
