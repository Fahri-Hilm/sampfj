...
CMD:help(playerid, params[])
{
	...
	ShowPlayerDialog(playerid, DIALOG_HELP, DIALOG_STYLE_LIST, "Hopixel Help Menu", info, "Select", "Close");
	return 1;
}
CMD:makan(playerid, params[])
{
    new string[320];
    format(string, sizeof(string), "Nasi Bungkus (%d)\nSiomay (%d)\nSnack (%d)\nEs Susu (%d)\nJus Jeruk (%d)\nSprunk (%d)", pData[playerid][pNasi], pData[playerid][pBurger], pData[playerid][pSnack], pData[playerid][pAyam], pData[playerid][pMineral], pData[playerid][pSprunk]);
	ShowPlayerDialog(playerid, DIALOG_MAKAN, DIALOG_STYLE_LIST, "PEDAGANG", string, "Pilih", "Batal");
	return 1;
}
...
CMD:credits(playerid)
{
	...
	strcat(line3, "Management: "YELLOW_E"KONG(Wahyu)\n");
	strcat(line3, "{FFFFFF}Assistant Management: "YELLOW_E"Clavin(XXBR)\n");
	strcat(line3, "{FFFFFF}Developer: "YELLOW_E"Clavin(XXBR) & Gio(Zytrax)\n");
	strcat(line3, "{FFFFFF}Developer Discord: "YELLOW_E"Wahyu\n");
	strcat(line3, "{FFFFFF}Support Mapper: "YELLOW_E"Clavin(XXBR)\n");
	strcat(line3, "{FFFFFF}Gamemode Creator: "YELLOW_E"Clavin, Gio For Update\n\n");
	strcat(line3, ""GREEN_E"Terima kasih telah bergabung dengan server kami! Copyright © 2022.");
...
CMD:vip(playerid)
{
	...
	strcat(longstr2, "\n\n"dot""PURPLE_E"GVIP(4) "PINK_E"Rp.150,000/month "RED_E"|| "PINK_E"Features:\n\
	"YELLOW_E"1) "WHITE_E"Gratis "LB_E"50 "WHITE_E"VIP Gold.\n\
	"YELLOW_E"2) "WHITE_E"Mendapat "GREEN_E"2 "WHITE_E"slot job.\n\
	"YELLOW_E"3) "WHITE_E"Akses custom VIP room dan VIP locker.");
	strcat(longstr2, "\n"YELLOW_E"4) "WHITE_E"Mempunyai "LB_E"6 "WHITE_E"slot untuk kendaraan pribadi.\n\
	"YELLOW_E"5) "WHITE_E"Mempunyai "LB_E"5 "WHITE_E"Slot untuk rumah.\n\
	"YELLOW_E"6) "WHITE_E"Mempunyai "LB_E"5 "WHITE_E"slot untuk bisnis.\n\
	"YELLOW_E"7) "WHITE_E"Akses VIP chat dan VIP status "LB_E"/vips"WHITE_E".");
	strcat(longstr2, "\n"YELLOW_E"8) "WHITE_E"Waktu Paycheck/Payday "LB_E"15% "WHITE_E"lebih cepat.\n\
	"YELLOW_E"9) "WHITE_E"Mendapatkan "LB_E"30% "WHITE_E"bunga bank setiap kali paycheck.");
	
	strcat(longstr2, "\n\n"dot""PURPLE_E"GBVIP (5) "PINK_E"Rp.200,000/month "RED_E"|| "PINK_E"Features:\n\
	"YELLOW_E"1) "WHITE_E"Gratis "LB_E"100 "WHITE_E"VIP Gold.\n\
	"YELLOW_E"2) "WHITE_E"Mendapat "GREEN_E"2 "WHITE_E"slot job.\n\
	"YELLOW_E"3) "WHITE_E"Akses custom VIP room dan VIP locker.");
	strcat(longstr2, "\n"YELLOW_E"4) "WHITE_E"Mempunyai "LB_E"6 "WHITE_E"slot untuk kendaraan pribadi.\n\
	"YELLOW_E"5) "WHITE_E"Mempunyai "LB_E"6 "WHITE_E"Slot untuk rumah.\n\
	"YELLOW_E"6) "WHITE_E"Mempunyai "LB_E"6 "WHITE_E"slot untuk bisnis.\n\
	"YELLOW_E"7) "WHITE_E"Akses VIP chat dan VIP status "LB_E"/vips"WHITE_E".");
	strcat(longstr2, "\n"YELLOW_E"8) "WHITE_E"Waktu Paycheck/Payday "LB_E"15% "WHITE_E"lebih cepat.\n\
	"YELLOW_E"9) "WHITE_E"Mendapatkan "LB_E"40% "WHITE_E"bunga bank setiap kali paycheck.");
	
	strcat(longstr2, "\n\n"dot""PURPLE_E"GMVIP (6) "PINK_E"Rp.250,000/month "RED_E"|| "PINK_E"Features:\n\
	"YELLOW_E"1) "WHITE_E"Gratis "LB_E"200 "WHITE_E"VIP Gold.\n\
	"YELLOW_E"2) "WHITE_E"Mendapat "GREEN_E"2 "WHITE_E"slot job.\n\
	"YELLOW_E"3) "WHITE_E"Akses custom VIP room dan VIP locker.");
	strcat(longstr2, "\n"YELLOW_E"4) "WHITE_E"Mempunyai "LB_E"6 "WHITE_E"slot untuk kendaraan pribadi.\n\
	"YELLOW_E"5) "WHITE_E"Mempunyai "LB_E"7 "WHITE_E"Slot untuk rumah.\n\
	"YELLOW_E"6) "WHITE_E"Mempunyai "LB_E"7 "WHITE_E"slot untuk bisnis.\n\
	"YELLOW_E"7) "WHITE_E"Akses VIP chat dan VIP status "LB_E"/vips"WHITE_E".");
	strcat(longstr2, "\n"YELLOW_E"8) "WHITE_E"Waktu Paycheck/Payday "LB_E"15% "WHITE_E"lebih cepat.\n\
	"YELLOW_E"9) "WHITE_E"Mendapatkan "LB_E"20% "WHITE_E"bunga bank setiap kali paycheck.");

	strcat(longstr2, "\n\n"LB_E"Pembayaran Via Pulsa/Paypal/Bank BRI/Unipin. "LB2_E"Harga VIP Gold "LB_E"Rp.1,000/gold.\n\
	"YELLOW_E"Untuk informasi selengkapnya hubungi administrator!");
	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""ORANGE_E"IP:RP "PINK_E"VIP SYSTEM", longstr2, "Close", "");
	return 1;
}
...
CMD:time(playerid)
{
	...
	format(line2, sizeof(line2), ""WHITE_E"Paycheck Time: "YELLOW_E"%d remaining\n"WHITE_E"Delay Job: "RED_E"%d Detik\n"WHITE_E"Delay Side Job: "RED_E"%d Detik\n"WHITE_E"Plant Time(Farmer): "RED_E"%d Detik\n"WHITE_E"Arrest Time: "RED_E"%d Detik\n"WHITE_E"Jail Time: "RED_E"%d Detik\n", paycheck, pData[playerid][pJobTime], pData[playerid][pSideJobTime], pData[playerid][pPlantTime], pData[playerid][pArrestTime], pData[playerid][pJailTime]);
   	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""ORANGE_E"IP:RP "WHITE_E"Time", line2, "Oke", "");
	return 1;
}
...
CMD:newidcard(playerid, params[])
{
	...
	if(pData[playerid][pMoney] < 50) return Error(playerid, "Anda butuh $50 untuk membuat ID Card");
...
CMD:newage(playerid, params[])
{
	if(!IsPlayerInRangeOfPoint(playerid, 3.0, -2082.9756, 2675.5081, 1500.9647)) return Error(playerid, "Anda harus berada di City Hall!");
	//if(pData[playerid][pIDCard] != 0) return Error(playerid, "Anda sudah memiliki ID Card!");
	if(pData[playerid][pMoney] < 300) return Error(playerid, "Anda butuh $300 untuk mengganti tgl lahir anda!");
	...
	foreach(new i : PVehicles)
	{
		if(vehid == pvData[i][cVeh])
		{
			if(pvData[i][cOwner] == pData[playerid][pID])
			{
				...
				if(ticket > pData[playerid][pMoney])
...
CMD:buyinsu(playerid, params[])
{
	...
	foreach(new i : PVehicles)
	{
		if(vehid == pvData[i][cVeh])
		{
			...
			{
				if(pData[playerid][pMoney] < 500) return Error(playerid, "Anda butuh $500 untuk membeli Insurance.");
				GivePlayerMoneyEx(playerid, -500);
				pvData[i][cInsu]++;
...
CMD:claimpv(playerid, params[])
{
	if(!IsPlayerInRangeOfPoint(playerid, 3.0, 1296.0533, -1264.1348, 13.5939))
	    return Error(playerid, "You're not at Vehicle Insurance!");
...
{
	if(!IsPlayerInRangeOfPoint(playerid, 3.0, 1027.6293,-1442.8956,14.4960)) return Error(playerid, "Anda harus berada di Bank!");
	if(pData[playerid][pMoney] < 50) return Error(playerid, "Not enough money!");
...
CMD:clavin(playerid, params[])
{
    new su[300];
    format(su, sizeof su, "%s", FormatMoney(pData[playerid][pBankMoney]));
   	PlayerTextDrawSetString(playerid, BankNew[playerid][0], su);
   	
   	new asu[300];
    format(asu, sizeof asu, "%s", FormatMoney(pData[playerid][pMoney]));
   	PlayerTextDrawSetString(playerid, BankNew[playerid][1], asu);
   	
    for(new i = 0; i < 47; i++)
	{
		TextDrawShowForPlayer(playerid, BankTD[i]);
	}
	for(new u = 0; u < 2; u++)
	{
		PlayerTextDrawShow(playerid, BankNew[playerid][u]);
	}
...
{
    if(IsPlayerInRangeOfPoint(playerid, 3.0, 1021.3434,-1442.8960,14.5160))
    {
	...
	if(pData[playerid][pVip] > 0)
	{
		if(pData[playerid][pJob] == 0 || pData[playerid][pJob2] == 0)
		{
			if(pData[playerid][pJob] == 0)
			{
				...
				else if(pData[playerid][pJob] == 0 && GetPlayerState(playerid) == 1 && IsPlayerInRangeOfPoint(playerid, 3.0, 1433.51, -968.358, 37.6965))
				{
					pData[playerid][pGetJob] = 11;
					Info(playerid, "Anda telah berhasil mendaftarkan Job Reflenish. /accept job untuk konfirmasi.");
				}
...
CMD:give(playerid, params[])
{
	...
	if(IsPlayerConnected(playerid)) 
	{
        ...
        if(sscanf(params, "us[24]d", otherid, name, ammount))
		{
			...
			Info(playerid, "Names: bandage, redmoney, medicine, snack, nasbung, Susu, Siomay, Jus, sprunk, material, component, marijuana, obat, gps");
			return 1;
		}
		...
		else if(strcmp(name,"Jus",true) == 0)
		{
			...
			Info(playerid, "Anda telah berhasil memberikan Jus Jeruk kepada %s sejumlah %d.", ReturnName(otherid), ammount);
			Info(otherid, "%s telah berhasil memberikan Jus Jeruk kepada anda sejumlah %d.", ReturnName(playerid), ammount);
			ApplyAnimation(playerid, "DEALER", "shop_pay", 4.0, 0, 0, 0, 0, 0);
			ApplyAnimation(otherid, "DEALER", "shop_pay", 4.0, 0, 0, 0, 0, 0);
		}
		else if(strcmp(name,"susu",true) == 0)
		{
			...
			Info(playerid, "Anda telah berhasil memberikan Es Susu kepada %s sejumlah %d.", ReturnName(otherid), ammount);
			Info(otherid, "%s telah berhasil memberikan Es Susu kepada anda sejumlah %d.", ReturnName(playerid), ammount);
			ApplyAnimation(playerid, "DEALER", "shop_pay", 4.0, 0, 0, 0, 0, 0);
			ApplyAnimation(otherid, "DEALER", "shop_pay", 4.0, 0, 0, 0, 0, 0);
		}
		else if(strcmp(name,"Siomay",true) == 0)
		{
			if(pData[playerid][pSnack] < ammount)
				return Error(playerid, "Item anda tidak cukup.");
			...
			Info(playerid, "Anda telah berhasil memberikan Siomay kepada %s sejumlah %d.", ReturnName(otherid), ammount);
			Info(otherid, "%s telah berhasil memberikan Siomay kepada anda sejumlah %d.", ReturnName(playerid), ammount);
			ApplyAnimation(playerid, "DEALER", "shop_pay", 4.0, 0, 0, 0, 0, 0);
			ApplyAnimation(otherid, "DEALER", "shop_pay", 4.0, 0, 0, 0, 0, 0);
		}
		...
		else if(strcmp(name,"component",true) == 0) 
		{
			...
			if(ammount > 20000)
				return Error(playerid, "Invalid ammount 1 - 20000");
		...
		else if(strcmp(name,"PaketBorax",true) == 0)
		{
            ...
            if(ammount > 50)
				return Error(playerid, "Invalid ammount 1 - 50");
...
CMD:use(playerid, params[])
{
	...
	if(IsPlayerConnected(playerid)) 
	{
        if(isnull(params)) 
		{
            ...
            Info(playerid, "Names: bandage, boombox, gas, medicine, marijuana, obat");
            return 1;
        }
		if(strcmp(params,"bandage",true) == 0) 
		{
			...
			if(darah+20 > 100) return Error(playerid, "Your Health Fuel!");
		...
		else if(strcmp(params,"gas",true) == 0) 
		{
			...
			if(IsValidVehicle(vehicleid))
			{
				...
				pData[playerid][pActivity] = SetTimerEx("RefullCar", 7000, false, "id", playerid, vehicleid);
				ShowProgressbar(playerid, "Refilling", 7);
				return 1;
			}
		}
...
CMD:mask(playerid, params[])
{
	if(pData[playerid][pLevel] < 3)
	    return SendErrorMessage(playerid, "You must level 3 first for using mask.");
	...
	switch (pData[playerid][pMaskOn])
    {
        case 0:
        {
            ...
            format(sstring, sizeof(sstring), "Mask_#%d", pData[playerid][pMaskID]);
            SetPlayerName(playerid, sstring);
		    pData[playerid][pNameTag] = Create3DTextLabel(sstring, -1, 0, 0, -0.25, 25, playerid, 10);
		    Attach3DTextLabelToPlayer(pData[playerid][pNameTag], playerid, 0, 0, 0.39);
...
CMD:s(playerid, params[])
{
    ...
    SendFactionMessage(3, ARWIN, "[SAMD EMERGENCY KILL] {ffffff}Player %s[%d] ask for help to cure it, location %s", GetRPName(playerid), playerid, lokasi);
    SendFactionMessage(3, ARWIN, "[INFO] {ffffff}/finddown for search player down");
	Info(playerid, "Pesan telah terkirim harap bersabar paramedic akan mencari lokasimu!");
...
CMD:buy(playerid, params[])
{
	...
	{
		if(pData[playerid][pComponent] >= 20000) return Error(playerid, "Anda sudah membawa 20000 Component!");
		new mstr[128];
	...
	//Apotek
	if(IsPlayerInRangeOfPoint(playerid, 2.5, 1341.716552, 1576.009887, 3010.906250))
	{
	...
	//spray
	if(IsPlayerInRangeOfPoint(playerid, 2.5, 1172.371704, -1361.600952, 13.953125))
	{
	    SendClientMessage(playerid, -1, "Lu tukang abuse dek");
		/*if(pData[playerid][pLevel] < 2)
			return Error(playerid, "You must level 2 to use this!");
	...
	// Obat Myr
	if(IsPlayerInRangeOfPoint(playerid, 2.5, 1330.2743, 1566.8224, 3010.9063))
	{
	...
	foreach(new id : Farm)
	{
		...
		{
			if(FarmData[id][farmPrice] > pData[playerid][pMoney]) return Error(playerid, "Not enough money, you can't afford this Privates Farm.");
	...
	foreach(new vid : Vendings)
	{
		...
		{
			if(VendingData[vid][vendingPrice] > pData[playerid][pMoney]) 
		...
		foreach(new hid : Houses)
		{
			if(IsPlayerInRangeOfPoint(playerid, 2.5, hData[hid][hExtposX], hData[hid][hExtposY], hData[hid][hExtposZ]))
			{
				...
				GetPlayerName(playerid, hData[hid][hOwnern], MAX_PLAYER_NAME);
		...
		foreach(new wid : Workshop)
		{
			...
			{
				if(wsData[wid][wPrice] > pData[playerid][pMoney]) return Error(playerid, "Not enough money, you can't afford this workshop.");
...
forward DownloadBinory(playerid);
public DownloadBinory(playerid)
{
	pData[playerid][pBinory] = 1;
	pData[playerid][pKuota] -= 38000;
	Servers(playerid, "Binory berhasil di Download");
}
...
CMD:newweaponlic(playerid, params[])
{
	...
	if(pData[playerid][pMoney] < 4000) return Error(playerid, "Anda butuh $4,000 untuk membuat Weapon License.");
...
CMD:tweet(playerid, params[])
{
    if(GetPVarInt(playerid, "maketw") > gettime())
        return Error(playerid, "Mohon Tunggu 10 Menit Untuk Menggunakan kembali (Don't Spam).");

    if(!pData[playerid][pTwitter]) return Error(playerid, "Anda Tidak Memiliki Aplikasi Twitter.");
    ...
    if(pData[playerid][pKuota] <= 500) return Error(playerid, "You dont have phone credits!");
	...
	pData[playerid][pKuota] -= 500;
	SetPVarInt(playerid, "maketw", gettime() + 600);
	return 1;
}
CMD:tlist(playerid)
{
    if(pData[playerid][pAdmin] < 1) return Error(playerid, "Your not admin dek");
	new mstr[4000];
