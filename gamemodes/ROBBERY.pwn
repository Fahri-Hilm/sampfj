...
{
	if(!IsPlayerInRangeOfPoint(playerid, 4.0, -1449.502319, -1530.669311, 101.757812)) return Error(playerid, "Anda tidak di tempat car stealing");
	if(RobCarDelay[playerid] > 0) return Error(playerid, "Anda sedang cooldown");
